...
fun main() {
    val arr1 = arrayOf(6, 7, 8, 9, 5)
    println("Created array using arrayOf() method: ")
    printArray(arr1)
    println()
    val arr2: Array<Int> = arrayOf(4, 7, 8, 9, 5)
    ...
    val arr5 = intArrayOf(15, 19, 0, 50, 16, 30)
    printArray(arr5.toTypedArray())
    println()
    println("Created array using arrayOf() and intArrayOf() method")
    val arr6 = arrayOf(intArrayOf(9, 2), intArrayOf(7, 4), intArrayOf(3, 6))
    printArray(arr6)
    println()
...
fun printArray(arr: Array<Int>) {     for (element in arr) {
    print(" $element")
} }
...
fun sortArray(arr: ArrayList<Int>): ArrayList<Int> {     var i: Int
var tmp: Int
